...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 d-flex justify-content-sm-end" style="padding: 9px;">
            <a class="btn btn-primary " role="button" href="{{ route('transaksi.index') }}">
    ...
    <div class="card  mb-3 text-dark">
        ...
        <div class="card-body">
                ...
                <div class="col-9">
                    <table class="table">
                        ...
                        @if ($transaksi->driver_id != NULL)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col">
                                            @if ($transaksi->driver->img == NULL)
                                                <img class="rounded-circle me-2" src="{{ url('assets/img/avatars/avatar6.jpeg') }}"  width="160" height="160" />
                                            @else
                                                <img class="rounded-circle me-2" src="{{ url('fotoaset/',$transaksi->driver->img) }}"  width="160" height="160" />
                                            @endif
                                        </div>
                                        <div class="col">
                                            <p>{{ $transaksi->driver->nama_driver }} <br>
                                        </div>
                                    </div>
                                </td>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-warning">{{ $transaksi->status_verifikasi }} </span></td>
                        <tr>
                        <tr>
            ...
            <div class="d-grid gap-2">
                <a class="btn btn-success" role="button" href="{{ route('transaksi.updateVerif',$transaksi->id) }}">VERIFY</a>
            </div>
        </div>
    </div> 
</div>
