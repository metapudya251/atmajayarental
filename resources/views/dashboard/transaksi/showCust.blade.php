...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 d-flex justify-content-sm-end" style="padding: 9px;">
            <a class="btn btn-primary " role="button" href="{{ route('transaksi.indexCust') }}">
...
<div class="container-fluid">
    <div class="card  mb-3 text-dark">
        ...
        <div class="card-body">
            ...
            @if ($transaksi->status_pembayaran != 'Lunas Menunggu Verifikasi' && $transaksi->status_pembayaran != 'Lunas')
                <div class="d-grid gap-2 mt-4">
                    <a href="{{ route('transaksi.editBayar', $transaksi->id) }} " type="button" class="btn btn-primary">Bayar</a>
                </div>
            @endif
        </div>
    </div> 
