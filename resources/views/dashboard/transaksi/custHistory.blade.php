        ...
        <div class="card-body">
            <div class="col-md-6">
                <div class="text-md-end dataTables_filter" id="dataTable_filter">
                    <form action="{{ route('transaksi.custHistory') }}">
                        @csrf			
                                    ...
                                    @if ($tr->customer_id == Auth::guard('customer')->user()->id)
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('transaksi.destroy',$tr->id) }}">
                                                    <a class="btn btn-success btn-circle ms-1" role="button" href="{{ route('transaksi.showCust2', $tr->id) }}"><i class="fas fa-info-circle text-white"></i></a>
