...
<div class="container-fluid">
  <h3 class="text-dark mb-4">Edit Pemilik</h3>
  ...
  <form action="{{ route('pemilik.update',$pemilik->id) }}" method="post">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="text" id="first_name" name="nama_pemilik" value="{{ old('nama_pemilik', $pemilik->nama_pemilik) }}">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="text" id="first_name" name="no_ktp" value="{{ old('no_ktp', $pemilik->no_ktp) }}">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" id="first_name" name="alamat_pemilik" value="{{ old('alamat_pemilik',$pemilik->alamat_pemilik) }}">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" id="first_name" name="noTelp_pemilik" value="{{ old('noTelp_pemilik',$pemilik->noTelp_pemilik) }}">
