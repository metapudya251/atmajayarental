...
<div class="container-fluid mt-3">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-primary m-0 fw-bold">History Transaksi</p>
        </div>
        <div class="card-body">
            <div class="col-md-6">
                <div class="text-md-end dataTables_filter" id="dataTable_filter">
                    <form action="{{ route('transaksi.history') }}">
                        @csrf			
                                ...
                                @foreach($transaksi as $tr)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-success btn-circle ms-1" role="button" href="{{ route('transaksi.showNota', $tr->id) }}"><i class="fas fa-info-circle text-white"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
